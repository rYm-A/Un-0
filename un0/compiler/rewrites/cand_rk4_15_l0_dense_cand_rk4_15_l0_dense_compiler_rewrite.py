...
@register_compiler_rewrite("cand_rk4_15_l0_dense")
@register_compiler_rewrite("compiler_rewrite")
def cand_rk4_15_l0_dense_compiler_rewrite_fn(
    model,
    solver_name="rk4",
    num_steps=45,
    dt=0.066667,
...
cand_rk4_15_l0_dense = cand_rk4_15_l0_dense_compiler_rewrite_fn
compiler_rewrite = cand_rk4_15_l0_dense_compiler_rewrite_fn
